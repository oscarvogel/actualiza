...
class BotonCopiaExe(Boton):

    exeorigen = "" #ejecutable del servidor
    exedestino = "" #ejecutable local
    carpetaorigen = "" #carpeta del servidor
    ...
    exclude = ['facturas', 'pdf'] #lista de carpetas a excluir en la copia
